...
int main() {
  ...
  // ------------------------------------
  Shader ourShader("../shader/v_shader.vs", "../shader/f_shader.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    ourShader.setMat4("projection", projection);  // note: currently we set the projection matrix each frame, but since the projection matrix rarely
